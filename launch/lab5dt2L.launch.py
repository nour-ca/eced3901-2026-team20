...
def generate_launch_description():
  ...
  static_map_path = os.path.join(pkg_share, 'maps', 'Challenge_L_map.yaml')
  map_save_path = os.path.join(pkg_share, 'maps', 'Challenge_L_map')
  nav2_params_path = os.path.join(pkg_share, 'params', 'nav2_params_original_backup.yaml')
